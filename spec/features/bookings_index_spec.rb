...
RSpec.feature 'Bookings index', type: :feature do
  let!(:booking1) do
    create(:booking, user_attributes: { first_name: 'John', last_name: 'Doe' },
                     animal_attributes: { name: 'Rex', animal_type: 'Dog' }, hours_requested: 2, date_of_service: Date.tomorrow)
  end
  let!(:booking2) do
    create(:booking, user_attributes: { first_name: 'Jane', last_name: 'Smith' },
                     animal_attributes: { name: 'Max', animal_type: 'Cat' }, hours_requested: 3, date_of_service: Date.today)
  end
